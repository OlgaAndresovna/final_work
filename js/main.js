...
const listener = (e) => {
  userPassFirst.style = (userPassFirst.value === userPassSecond.value) ? "border: 1px solid green" : "border: 1px solid red";
  userPassSecond.style = (userPassFirst.value === userPassSecond.value) ? "border: 1px solid green" : "border: 1px solid red";
